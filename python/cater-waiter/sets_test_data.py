...
all_drinks = [('Amaretto Sour', ['almond liqueur', 'bourbon', 'cherries', 'egg white', 'lemon juice', 'lemon twist', 'simple syrup']),
              ...
              ('Bannana Punch',
               ['banana',
                ...
                'sugar',
                'water']),
              ('Beet Sumac Soda', ['beet', 'club soda',
                                   'fresh lemon juice', 'sugar', 'sumac']),
              ...
              ('Bloody Mary',
               ['celery',
                ...
                'vodka',
                'worcestershire sauce']),
              ('Bloody Shame', ['V8 juice', 'black pepper',
              ...
              ('Chile-lime Pineapple Soda',
               ['chiles de árbol',
                ...
                'pink peppercorns',
                'sugar']),
              ('Citrus Fizz', ['organic marmalade cordial',
                               'seedlip grove 42', 'sparkling water']),
              ('Dry Martini', ['dry vermouth',
                               'gin', 'lemon twist', 'olives']),
              ('Espresso Martini', ['coffee liqueur',
                                    'espresso', 'sugar syrup', 'vodka']),
              ...
              ('Maple-Ginger Cider Switchel',
               ['apple cider vinegar',
                ...
                'maple syrup',
                'mint sprigs']),
              ('Margarita', ['lime juice', 'salt',
                             'simple syrup', 'tequila', 'triple sec']),
              ('Mojito', ['lime', 'mint leaves',
                          'soda water', 'sugar syrup', 'white rum']),
              ('Moscow Mule', ['ginger beer',
                               'lime', 'lime juice', 'vodka']),
              ('Negroni', ['bitters', 'gin', 'sweet vermouth']),
              ('Old Fashioned', ['bitters', 'bourbon',
                                 'orange juice', 'orange slices', 'sugar']),
              ...
              ('Whiskey Sour', ['cherry', 'lemon juice',
                                'lemon slices', 'superfine sugar', 'whiskey'])
              ]
...
group_2 = [(item[1], item[2])
           for item in recipes_without_duplicates if item[1] in nondupes]

dishes_to_special_label = sorted(group_1 + group_2)

dishes_labeled = [('Baked Kelewele', {'red onion'}),
                  ('Barley Risotto', {
                      'garlic', 'red onion', 'parmesan cheese'}),
                  ('Brisket with Grilled Rhubarb, Onions, and Fennel', {
                  ...
                  ('Shakshuka', {'tomatoes', 'tomato paste',
                                 'firm tofu', 'yellow onion'}),
                  ('Shrimp, Bacon and Crispy Chickpea Tacos with Salsa de Guacamole', {
                      'shrimp', 'garlic', 'butter', 'slivered almonds', 'bacon'}),
                  ('Summer Minestrone Cups', {
                      'garlic', 'tomatoes', 'parmesan cheese'}),
...
ingredients_only = [[{'bulgur', 'pomegranate molasses', 'chopped parsley', 'lemon juice', 'tomato', 'persian cucumber', 'tomato paste', 'spring onion', 'water', 'olive oil'},
                     ...
                     {'smoked paprika',
                      ...
                      'salt',
                      'ripe plantains'},
                     {'baking soda', 'sorghum stems', 'coconut oil',
                     ...
                     {'mushrooms',
                      ...
                      'orange zest',
                      'allspice powder'},
                     {'green onions', 'lemon juice', 'lemon zest', 'dill', 'corn',
                         'tomatoes', 'black pepper', 'zucchini', 'olive oil'},
                     {'mustard seeds',
                      'cumin seeds',
                      'lemon juice',
                      'garlic',
                    ...
                    [{'baking soda', 'coconut flour', 'lemon juice', 'lemon zest', 'eggs', 'coconut yogurt', 'black pepper', 'fresh thai chili', 'coconut oil', 'chives', 'zucchini', 'salt'},
                     ...
                     {'coconut flour',
                      ...
                      'salt',
                      'fresh red chili'},
                     {'mustard seed', 'onion', 'kale',
                         'cherry tomatoes', 'bacon', 'paleo mayonnaise'},
                     {'purple sweet potato',
                      'chiles de árbol',
                      'garlic',
                      'tomatoes',
...
dishes_and_overlap = [(item[0], item[1])
                      for item in zip(ingredients_only, intersections)]
