...
# decode that they need to create and title their constants and functions
# in a specific way.
try:
...
# Here, we are separating the constant import errors from the function
# name import errors
