...
class ClassesTest(unittest.TestCase):
  ...
  def test_alien_has_correct_initial_coordinates(self):
    ...
    self.assertEqual(
        (2, -1), (alien.x_coordinate, alien.y_coordinate), msg=error)
  ...
  def test_alien_instance_variables(self):
    ...
    self.assertFalse(
        alien_one.x_coordinate == alien_two.x_coordinate,
        msg=coord_x_error)
    self.assertFalse(
        alien_one.y_coordinate == alien_two.y_coordinate,
        msg=coord_y_error)
