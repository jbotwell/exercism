...
public static class Languages {
  public static List<string> NewList() { return new List<string>(); }
  ...
  public static bool IsExciting(List<string> languages) {
    int cSharpPlace = languages.FindIndex(e => e == "C#");
    return ((cSharpPlace == 0) || (cSharpPlace == 1 && (languages.Count == 2 ||
                                                        languages.Count == 3)));
  }
  ...
  public static bool IsUnique(List<string> languages) {
    ...
    return langSet.Count == languages.Count;
  }
}
